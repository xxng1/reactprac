...
<div style={{width: '100%', height: '100%', position: 'relative', background: 'white'}}>
    ...
    <div style={{width: 1119, height: 240, left: 160, top: 390, position: 'absolute', borderRadius: 10}}>
        ...
        <div style={{width: 52, height: 20, left: 157, top: 182, position: 'absolute', textAlign: 'center', color: 'white', fontSize: 13, fontFamily: 'Roboto', fontWeight: '600', wordWrap: 'break-word', cursor: 'pointer' }} onClick={handlePurchaseClick} >구매하기</div>
